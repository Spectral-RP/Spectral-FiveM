Config                  = {}
Config.DynamicWeather   = true -- Set this to false if you don't want the weather to change automatically every 15 minutes.
...
Config.NewWeatherTimer  = 15 -- Time (in minutes) between each weather change   default: 30
